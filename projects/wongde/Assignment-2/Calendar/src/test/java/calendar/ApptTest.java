...
@Test(timeout = 4000)
 public void test02()  throws Throwable  {
      ...
      assertEquals(2, appt0.getRecurBy());
      assertFalse(appt0.isRecurring());
      // fails due to bug assertEquals("\t15/10/2018 at -1:-1am ,Birthday Party, This is my birthday party\n", string0);
      assertEquals(0, appt0.getRecurIncrement());
      appt0.setValid();
  ...
  public void test05()  throws Throwable  {
      ...
      assertFalse(appt0.isRecurring());
	  String string0 = appt0.toString();
      //fails, not sure if bug or not assertEquals("\t9/14/2018 at 3:00pm ,Birthday Party, This is my birthday party\n", string0);
      assertEquals(0, appt0.getRecurIncrement());
      appt0.setValid();
  }
    @Test(timeout = 4000)
  ...
  public void test08()  throws Throwable  {
      ...
      assertFalse(appt0.isRecurring());
      appt0.setValid();
	  //fails due to setValid bug, assertFalse(appt0.getValid());
  }
    @Test(timeout = 4000)
 ...
 @Test(timeout = 4000)
  public void test12()  throws Throwable  {
	  ...
	  //assertTrue(appt0.isOn(14,9,2021));
	  assertEquals(3, appt0.getRecurBy());
	  assertEquals(500, appt0.getRecurNumber());
	  // fails due to bug assertEquals(0, (appt0.getRecurDays()).length);
      assertTrue(appt0.isRecurring());
      appt0.setValid();
