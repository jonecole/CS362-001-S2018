...
public class CalDayTest{
  ...
  public void test00()  throws Throwable  {
    ...
    // fails due to bug assertEquals("\t --- 12/25/2018 --- \n --- -------- Appointments ------------ --- \n\n", string0); 
	calday0.addAppt(appt0);
	String string1 = calday0.toString();
	// fails since code (not my bug) is not adding preceding 0 to minute assertEquals("\t --- 12/25/2018 --- \n --- -------- Appointments ------------ --- \n\t9/14/2018 at 5:00pm,Birthday Party, This is my birthday party\n \n", string1); 
	String string2 = calday0.getFullInfomrationApp(calday0);
	//run and add correct
	// fails due to bug assertEquals("12-25-2018 \n\t5:00PM Birthday Party This is my birthday party \n\t8:45PM 3rd Birthday Party This is my friend's birthday party ", string2);
  }
    @Test(timeout = 4000)
  ...
  public void test01()  throws Throwable  {
	...
	GregorianCalendar day = new GregorianCalendar(2018, 11, 25);
	CalDay calday0 = new CalDay(day);
	Appt appt0 = new Appt(17, 5, 14, 9, 2018, "Birthday Party", "This is my birthday party", "xyz@gmail.com");
	...
	String string1 = calday0.toString();
	// fails since code (not my bug) is not adding preceding 0 to minute assertEquals("\t --- 12/25/2018 --- \n --- -------- Appointments ------------ --- \n\t9/14/2018 at 5:05pm,Birthday Party, This is my birthday party\n \n", string1); 
	String string2 = calday0.getFullInfomrationApp(calday0);
	// fails due to bug assertEquals("12-25-2018 \n\t5:05PM Birthday Party This is my birthday party ", string2);
  }
      @Test(timeout = 4000)
	  //test ordering
  public void test02()  throws Throwable  {
	...
	String string2 = calday0.getFullInfomrationApp(calday0);
	// fails due to bug assertEquals("12-25-2018 \n\t12:10AM 5th Birthday Party This is my friend's birthday party", string2);
  }
      @Test(timeout = 4000)
	  //test ordering
