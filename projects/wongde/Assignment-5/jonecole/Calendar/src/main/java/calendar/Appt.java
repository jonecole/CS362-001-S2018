...
public class Appt{
	...
	public void setValid() {
		...
		if (startMonth < 1 || startMonth > 12)
			...
			int NumDaysInMonth = CalendarUtil.NumDaysInMonth(startYear, startMonth - 1); //bugged code was int NumDaysInMonth = CalendarUtil.NumDaysInMonth(startYear, startMonth);
    ...
    public boolean isOn(int day, int month, int year) {
        return (day == getStartDay() && month == getStartMonth()
                && year == getStartYear()); // was return (day == getStartDay() "||" month == getStartMonth()&& year == getStartYear());
    }
